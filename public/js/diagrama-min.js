...
function init(){
    ...
    }(myDiagram=e(go.Diagram,"myDiagramDiv",{"undoManager.isEnabled":!0,mouseDrop:function(e){o(e,null)},layout:e(go.TreeLayout,{angle:90,sorting:go.TreeLayout.SortingAscending})})).nodeTemplate=e(go.Node,"Auto",e(go.Shape,"RoundedRectangle",{strokeWidth:0,fill:"white"},{portId:"",cursor:"pointer",fromLinkable:!0,fromLinkableSelfNode:!0,fromLinkableDuplicates:!0,toLinkable:!0,toLinkableSelfNode:!0,toLinkableDuplicates:!0},new go.Binding("fill","color")),e(go.TextBlock,{margin:8,font:"bold 14px sans-serif",stroke:"#333"},new go.Binding("text","name")),{toolTip:e("ToolTip",e(go.TextBlock,{margin:4},new go.Binding("text","",(function(e){var o="";
    switch(e.type){ 
